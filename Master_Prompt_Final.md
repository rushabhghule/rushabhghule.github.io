...
2. **Training & Placement Coordinator** (Neville Wadia Institute of Management Studies & Research, Mar 2026-Present)
   ...
   - Coordinated campus recruitment drives and facilitated interview processes
   - Ensured smooth communication between students, recruiters, and faculty
   - Provided administrative and operational support to the Training & Placement Cell

3. **Cultural Representative / Cultural Secretary** (Neville Wadia Institute of Management Studies & Research, Sep 2025-Present)
   - Planned and executed flagship college events and regular student programs
   - Organized guest lecture sessions and management movie screenings to promote learning
   - Led interactive cultural activities, talent showcases, and sports tournaments
   - Coordinated with faculty, student teams, and event participants for successful delivery of academic, cultural, and recreational initiatives
...
3. Use Rushabh's profile as source of truth
...
11. CONTINUE RULE: If output cuts off, user will respond with "CONTINUE" to resume from where it stopped. Do NOT restart - pick up exactly where you left off with the next output.
...
**Format:** ONE PAGE ONLY. Header | Professional Summary | Experience | Education | Skills | Projects

**EXPERIENCE RULES:**
- Include ONLY top 3 most relevant experiences for target role
- Each experience: 3-4 bullet points maximum (no more than 4)
- Reorder by job relevance, focus on quantified results
- If multiple NWIMSR roles included: mention organization name once, present as separate roles under same organization
- ATS-friendly, action verbs, no tables/columns
...
**E) Your Unique Value Proposition:** What makes Rushabh different/uniquely suited
...
**F) Confidence Talking Points:** Top 5 reasons Rushabh is right for this role
