...
1. **BoardMaster** (Current Project - MVP/Beta) | https://github.com/rushabhghule/boardmaster
   - AI-powered automation tool that streamlines Pinterest pin management using Claude API
   - Automates curation of pin titles, descriptions, and SEO optimization
   - Reduces manual content-posting time by 15–30 minutes per session
   - Tech stack: Claude API with Python

2. **CandidatePro** (Current Project - In Development) | https://github.com/rushabhghule/candidatepro
   - Comprehensive job application prep system using Claude API master-prompt methodology
   - Generates tailored resumes, company research briefs, outreach messages, interview prep, cover letters, role-specific strategy (L1/L2 phases)
   - System customizes all outputs based on specific job descriptions and candidate experience
...
4. **Process Optimization Research – Bright LumiTech** (Feb-Mar 2026)
   - Comprehensive workflow analysis identifying and resolving critical bottlenecks in 5-stage engineering process
   - Analyzed workflow through 25-30 employee interviews and process mapping
   - Identified design phase bottleneck consuming 60% of total time
   - Developed standardized intake templates, SOPs, and process documentation

**Certifications:**

1. **Inbound Certified** (HubSpot Academy, Issued Aug 2026, Valid until Sep 2028)
   - Credential: https://academy.hubspot.com/credentials/01ae72871c764dc8b1d9721c57385af5
   - Covers Inbound Marketing, Customer Journey Mapping, and advanced sales/marketing skills
